...
//   https://montebaur.tech/hose_connectors.html#parameterization
hc_pipe_inner_dia =  [hc4mm_pipe_inner_dia, hc8mm_pipe_inner_dia];  // a
hc_pipe_outer_dia =  [hc4mm_pipe_outer_dia, hc8mm_pipe_outer_dia];  // b
hc_outer_dia_lower = [hc4mm_outer_dia_lower, hc8mm_outer_dia_lower];  // c
hc_outer_dia_upper = [hc4mm_outer_dia_upper, hc8mm_outer_dia_upper];  // d
hc_tooth_length =    [hc4mm_tooth_length, hc8mm_tooth_length];  // e
hc_tooth_number =    [hc4mm_tooth_number, hc8mm_tooth_number];  // #teeth
